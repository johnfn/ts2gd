 ...
 *
*/
declare class ImmediateGeometry3D extends GeometryInstance3D {
 ...
 *
*/
begin(primitive: int, texture?: Texture2D): void;
...
set_uv2(uv: Vector2): void;
  ...
  connect<T extends SignalsOf<ImmediateGeometry3D>, U extends Node>(signal: T, node: U, method: keyof U): number;
