...
declare function main(target: Node, name: string): void
...
declare const Yield: <T, U extends keyof T>(
  obj: KeysOnly<T, Signal<any>>,
  name: U
) => void
declare const y: <T, U extends keyof T>(
  obj: KeysOnly<T, Signal<any>>,
  name: U
) => SignalReturnValue<T[U]>
