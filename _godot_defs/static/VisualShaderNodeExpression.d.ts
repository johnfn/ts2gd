...
expression: string;
  ...
  connect<T extends SignalsOf<VisualShaderNodeExpressionSignals>>(signal: T, method: SignalFunction<VisualShaderNodeExpressionSignals[T]>): number;
...
declare class VisualShaderNodeExpressionSignals extends VisualShaderNodeGroupBaseSignals {
