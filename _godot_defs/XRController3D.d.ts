 ...
 *
*/
declare class XRController3D extends Node3D {
...
/**
 * The degree to which the controller vibrates. Ranges from `0.0` to `1.0` with precision `.01`. If changed, updates [member XRPositionalTracker.rumble] accordingly.
 *
...
is_button_pressed(button: int): boolean;

  connect<T extends SignalsOf<XRController3D>, U extends Node>(signal: T, node: U, method: keyof U): number;
