...
/** No documentation provided. */
area_set_area_monitor_callback(area: RID, receiver: Object, method: StringName): void;
 ...
 *
*/
area_set_monitor_callback(area: RID, receiver: Object, method: StringName): void;
...
body_add_force(body: RID, force: Vector2, position?: Vector2): void;
...
body_set_force_integration_callback(body: RID, receiver: Object, method: StringName, userdata?: any): void;
...
body_test_motion(body: RID, from: Transform2D, motion: Vector2, infinite_inertia: boolean, margin?: float, result?: PhysicsTestMotionResult2D): boolean;
...
space_set_param(space: RID, param: int, value: float): void;
  ...
  connect<T extends SignalsOf<PhysicsServer2DClass>, U extends Node>(signal: T, node: U, method: keyof U): number;
 ...
 *
*/
static DAMPED_SPRING_REST_LENGTH: 0;
 ...
 *
*/
static DAMPED_SPRING_STIFFNESS: 1;
 ...
 *
*/
static DAMPED_SPRING_DAMPING: 2;
