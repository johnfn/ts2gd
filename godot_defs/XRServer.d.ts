...
get_tracker(idx: int): XRPositionalTracker;

/** Returns the number of trackers currently registered. */
get_tracker_count(): int;

  connect<T extends SignalsOf<XRServerClass>, U extends Node>(signal: T, node: U, method: keyof U): number;
 ...
 *
*/
interface_added: Signal<(interface_name: StringName) => void>

/**
 * Emitted when an interface is removed.
 *
*/
interface_removed: Signal<(interface_name: StringName) => void>
 ...
 *
*/
tracker_added: Signal<(tracker_name: StringName, type: int, id: int) => void>

/**
 * Emitted when a tracker is removed. You should remove any [XRController3D] or [XRAnchor3D] points if applicable. This is not mandatory, the nodes simply become inactive and will be made active again when a new tracker becomes available (i.e. a new controller is switched on that takes the place of the previous one).
 *
*/
tracker_removed: Signal<(tracker_name: StringName, type: int, id: int) => void>
