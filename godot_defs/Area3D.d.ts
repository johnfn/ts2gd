...
set_collision_mask_bit(bit: int, value: boolean): void;
  ...
  connect<T extends SignalsOf<Area3D>, U extends Node>(signal: T, node: U, method: keyof U): number;
 ...
 *
*/
area_entered: Signal<(area: Area3D) => void>

/**
 * Emitted when another area exits.
 *
*/
area_exited: Signal<(area: Area3D) => void>
 ...
 *
*/
area_shape_entered: Signal<(area_id: int, area: Area3D, area_shape: int, self_shape: int) => void>

/**
 * Emitted when another area exits, reporting which areas were overlapping.
 *
*/
area_shape_exited: Signal<(area_id: int, area: Area3D, area_shape: int, self_shape: int) => void>
