 ...
 *
 * For reference, the default vertical field of view value (`75.0`) is equivalent to an horizontal FOV of:
 *
...
unproject_position(world_point: Vector3): Vector2;
  ...
  connect<T extends SignalsOf<Camera3D>, U extends Node>(signal: T, node: U, method: keyof U): number;
