...
get_nav_path(): PackedVector3Array;
...
set_velocity(velocity: Vector3): void;
  ...
  connect<T extends SignalsOf<NavigationAgent3D>, U extends Node>(signal: T, node: U, method: keyof U): number;
