 ...
 *
*/
add_handles(handles: PackedVector3Array, material: Material, billboard?: boolean, secondary?: boolean): void;
 ...
 *
*/
set_handle(index: int, camera: Camera3D, point: Vector2): void;
...
set_spatial_node(node: Node): void;
  ...
  connect<T extends SignalsOf<EditorNode3DGizmo>, U extends Node>(signal: T, node: U, method: keyof U): number;
